...
<p align="center">
  <a href="https://github.com/ckq184/miniclaw">GitHub</a> ·
...
```bash
git clone https://github.com/ckq184/miniclaw.git
cd miniclaw
...
Agent 容器镜像默认使用 `ckq184/miniclaw-agent:latest`，可以通过 `MINICLAW_CONTAINER_IMAGE` 或 `CONTAINER_IMAGE` 覆盖。
...
| `MINICLAW_CONTAINER_IMAGE` | Agent Runner 使用的容器镜像 | `ckq184/miniclaw-agent:latest` |
